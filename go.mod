...
require (
	...
	golang.org/x/exp v0.0.0-20211221174106-5559a165f5d7 // indirect
	...
	k8s.io/metrics v0.23.0 // indirect
...
replace (
	...
	k8s.io/kubectl => github.com/openshift/kubernetes-kubectl v0.0.0-20211216124125-fc0f9e6f591f
)
